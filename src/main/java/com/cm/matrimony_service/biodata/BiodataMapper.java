...
public class BiodataMapper {
	...
	public BiodataResponse toResponse(Biodata biodata) {
		...
		return new BiodataResponse(
			...
			biodata.getGotra(),
			biodata.getMool(),
			biodata.getDateOfBirth(),
			biodata.getBirthTime(),
			biodata.getBirthPlace(),
			biodata.getFatherName(),
			biodata.getMotherName(),
			biodata.getSiblingsDetail(),
			biodata.getGrandparentName(),
			biodata.getReligion(),
			biodata.getCaste(),
